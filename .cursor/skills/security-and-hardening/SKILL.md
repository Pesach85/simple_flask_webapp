...
These are prevention patterns, not a ranking. For the 2021 ordering, see the quick-reference table in `../_references/security-checklist.md`.
...
For detailed security checklists and pre-commit verification steps, see `../_references/security-checklist.md`.
